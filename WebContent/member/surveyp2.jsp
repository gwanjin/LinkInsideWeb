...
<body>
	...
	<section id="about" class="home-section3 color-dark bg-white">
		<div class="container marginbot-50" >
			<div class="row" >
				<div class="col-lg-8 col-lg-offset-2">
					...
					<h2 class="h-bold">personality survey</h2>
					<div class="divider-header"></div>
					<p class="title" >Link Insideのマッチングサービスは性格適性検査を済んでから利用可能です。멘트수정</p>
					</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
       	 <div class="row" id="innerLine" style="text-align: center;">
   ...
   <script src="assets/js/jquery.nicescroll.js" type="text/javascript"></script>
	...
	<!-- 성격검사 문항 자바스크립트 -->
	<script src="script/surveyPersonality2.js" type="text/javascript"></script>
