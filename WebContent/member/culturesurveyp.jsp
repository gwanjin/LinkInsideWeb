...
<body>
	...
	<form id="dataform" action="culturePersonResult">
		<input type="hidden" value="<s:property value="%{#session.loginId}"/>" id="applicantid" name="culture.applicantid">
	</form>
		...
		<div class="container">
			<div class="row" >
				<div class="col-lg-8 col-lg-offset-2">
					...
					<h2 class="h-bold">culture survey</h2>
   ...
   <script src="assets/js/jquery.nicescroll.js" type="text/javascript"></script>
	...
	<!-- 성격검사 문항 자바스크립트 -->
	<script src="script/cultureapplicant.js" type="text/javascript"></script>
