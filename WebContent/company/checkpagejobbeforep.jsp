...
<body>
<form id="formdata">
	<input type="hidden" value="<s:property value="%{personality.applicantid}"/>" name="personality.applicantid">
</form>
	<section id="main-content">
		...
		<section class="wrapper">
			<div class="showback">
				<h4>
					<i class="fa fa-angle-right"></i>	50項目を追加選択するともっと高いマッチング企業の確認ができます。
				</h4>
				<p>
					<button type="button" class="btn btn-primary btn-lg" id="moreTest"> 50項目追加選択はこちら</button>
					
				</p>
				<h4>
					<i class="fa fa-angle-right"></i> いいえ. 大丈夫です。
				</h4>
				<p>
					<button type="button" class="btn btn-default btn-lg" id="stopTest"> 続ける </button>
				</p>
			</div>
		</section>
	</section>
